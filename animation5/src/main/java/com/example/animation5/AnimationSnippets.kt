...
@Composable
@Preview
fun AnimatedVisibilityAnimateEnterExitChildren() {
...
@OptIn(ExperimentalAnimationApi::class)
@Composable
fun AnimatedContentTransitionSpec(count: Int) {
...
object UpdateTransitionCreateChildTransition {
...
@OptIn(ExperimentalAnimationApi::class, ExperimentalMaterialApi::class)
@Composable
fun UpdateTransitionAnimatedVisibility() {
